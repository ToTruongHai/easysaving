    ...
    return data?.map((item: any, index: any) => {
      return (
        ...
        >
          ...
          <td className="px-6 py-4 flex gap-3 justtify-center item-center">
            <Image
              src={editIcon}
              alt="abc"
              width={30}
              height={30}
              className="border rounded-lg border-green-500 bg-green-200 cursor-pointer"
            ...
            <Image
              ...
              width={30}
              height={30}
              className="border rounded-lg border-red-500 bg-red-200 cursor-pointer"
